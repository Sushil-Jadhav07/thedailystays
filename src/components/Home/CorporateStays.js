...
const CorporateStays = () => {
  return (
    ...
    <div className='grid items-center grid-cols-1 gap-4 lg:gap-12 lg:grid-cols-2 grid-flow-row' >
        <div>
        <h3 className='text-[20px] font-[QuicksandBold] mb-1 lg:text-[2.5rem]'>Corporate Stays, <span className='uppercase'>Made Effortless </span> </h3>
      ...
      <br /><br />  <strong className='font-[QuicksandBold] italic text-[1rem] text-[#75665f] lg:text-[1.5rem] uppercase '>
